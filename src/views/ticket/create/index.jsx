...
import { getCreate, deleteCreate, editCreate, addCreate } from "@/api/create";
import { getCatalog, getTicketUser} from "@/api/ticket";
import TypingCard from '@/components/TypingCard'
import EditCreateForm from "./forms/edit-create-form"
import AddCreateForm from "./forms/add-create-form"
...
class Create extends Component {
  ...
  render() {
    ...
    const title = (
      <span>
        <Button type='primary' onClick={this.handleAddCreate}>Agregar nuevo</Button>
      </span>
    )
    const cardContent = `Se utiliza para crear nuevos ticket, estos seran asignados automaticamente a un usuario operador.`
    return (
      <div className="app-container">
        <TypingCard title='Gestión de ticket' source={cardContent} />
        <br/>
        <Card title={title}>
